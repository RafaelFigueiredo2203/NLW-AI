...
interface VideoInputormProps{
  onVideoUploaded:(id: string) => void

}

export function VideoInputForm(props: VideoInputormProps){
...
function handleFielSelected(event:ChangeEvent<HTMLInputElement>){
...
async function handleUploadVideo(event: FormEvent<HTMLFormElement>){
  ...
  return(
    <form onSubmit={handleUploadVideo} className="space-y-6">
              ...
              <input type="file" id="video" accept="video/mp4" onChange={handleFielSelected} className="sr-only" />
              ...
              <Button data-success={status === 'success'} disabled={status !== 'waiting'} type="submit" 
